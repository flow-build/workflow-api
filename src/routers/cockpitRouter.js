...
const { getNodes, getNodesTypes, fetchNodeSpec } = require("../controllers/cockpit/nodes")
...
module.exports = (opts = {}) => {
  ...
  nodes.prefix("/nodes");
  nodes.get('/', getNodesTypes)
  nodes.post("/", cockpitValidator.validateFetchNodeSchema, fetchNodeSpec)
  nodes.post("/query", getNodes)
